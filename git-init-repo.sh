...
# === DEFAULTS ===
REPO_PATH="~/devel/Linux"
BRANCH="main"
REMOTES=(
  "linux-mainline=https://github.com/torvalds/linux.git"
  "linux-stable=https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux.git"
  "rpi=https://github.com/raspberrypi/linux.git"
  "linux-xlnx=https://github.com/Xilinx/linux-xlnx.git"
  "linux-imx=https://github.com/nxp-imx/linux-imx.git"
  )
